                    ...
                    @forelse ($notificaciones as $notificacion)
                        <div class="p-5 border border-gray-200 lg:flex lg:justify-between lg:items-center">
                            ...
                            <div class="mt-5 lg:mt-0">
                                <a href="{{ route('candidatos.index', $notificacion->data['id_vacante']) }}" class="uppercase font-bold rounded-lg text-white bg-indigo-600 text-sm p-3">Ver Candidatos</a>
                            </div>
                        </div>
                    @empty
                        <p class="text-center text-gray-600">Sin notificaciones para mostrar</p>
                    @endforelse
                </div>
            </div>
        </div>
