        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h1 class="text-2xl font-bold text-center my-5">Candidatos de Vacante: {{ $vacante->titulo }}</h1>
                    ...
                    <div class="p-5">
                        <ul class="divide-y divide-gray-200">
                            ...
                            @empty
                                <p class="text-sm text-gray-600 p-3 text-center">Sin candidatos para mostrar</p>
                            @endforelse
                        </ul>
                    </div>
                </div>
